 ...
 *  ver. 2.0.0 2023-04-29 (kkossev) - driver name changed to 'Zigbee - Generic Switch (w/ healthStatus)'; capability 'PresenceSensor' replaced w/ capability 'HealthCheck' (attribute 'healthStatus')
 *
 */

def version() { "2.0.0" } 
def timeStamp() {"2023/04/29 10:10 PM"}
...
metadata {
	definition (name: "Zigbee - Generic Switch (w/ healthStatus)", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-generic-switch", importUrl: "https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-generic-switch-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Generic Switch (w/ healthStatus)', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-generic-switch', 'importUrl': 'hhttps://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-generic-switch-expanded.groovy']
