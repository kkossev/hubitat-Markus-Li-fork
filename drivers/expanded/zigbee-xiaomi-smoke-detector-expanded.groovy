 ...
 *  ver. 2.0.0 2023-07-10 (kkossev) - driver name changed to 'Zigbee - Xiaomi Smoke Detector (w/ healthStatus)'; capability 'PresenceSensor' replaced w/ capability 'HealthCheck' (attribute 'healthStatus')
 *
 */

def version() { "2.0.0" } 
def timeStamp() {"2023/07/10 12:10 PM"}
...
metadata {
	definition (name: "Zigbee - Xiaomi Smoke Detector (w/ healthStatus)", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-xiaomi-smoke-detector", importUrl: "https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-xiaomi-smoke-detector-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Xiaomi Smoke Detector (with healthStatus)', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-xiaomi-smoke-detector', 'importUrl': 'https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-xiaomi-smoke-detector-expanded.groovy']
