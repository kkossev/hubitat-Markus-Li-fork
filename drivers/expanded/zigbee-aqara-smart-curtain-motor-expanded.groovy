...
def version() { "2.0.0" } 
def timeStamp() {"2023/07/10 1:10 PM"}
...
metadata {
	definition (name: "Zigbee - Aqara Smart Curtain Motor (w/ healthStatus)", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-aqara-smart-curtain-motor", importUrl: "https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-aqara-smart-curtain-motor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Aqara Smart Curtain Motor (w/ healthStatus)', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-aqara-smart-curtain-motor', 'importUrl': 'https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-aqara-smart-curtain-motor-expanded.groovy']
