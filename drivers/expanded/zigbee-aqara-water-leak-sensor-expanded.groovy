 ...
 *  ver. 2.0.0 2023-07-10 (kkossev) - driver name changed to 'Zigbee - Aqara Water Leak Sensor (w/ healthStatus)'; capability 'PresenceSensor' replaced w/ capability 'HealthCheck' (attribute 'healthStatus')
 *
 */

def version() { "2.0.0" } 
def timeStamp() {"2023/07/10 4:49 PM"}
...
metadata {
	definition (name: "Zigbee - Aqara Water Leak Sensor (w/ healthStatus)", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-aqara-water-leak-sensor", importUrl: "https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-aqara-water-leak-sensor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Aqara Water Leak Sensor (with healthStatus)', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-aqara-water-leak-sensor', 'importUrl':'https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-aqara-water-leak-sensor-expanded.groovy']
