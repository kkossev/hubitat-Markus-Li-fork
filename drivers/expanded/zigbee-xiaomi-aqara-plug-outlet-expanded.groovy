 ...
 *  ver. 2.0.0 2023-07-10 (kkossev) - driver name changed to 'Zigbee - Xiaomi/Aqara Plug/Outlet (w/ healthStatus)'; capability 'PresenceSensor' replaced w/ capability 'HealthCheck' (attribute 'healthStatus')
 *
 */
...
metadata {
	definition (name: "Zigbee - Xiaomi/Aqara Plug/Outlet (w/ healthStatus)", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-xiaomi-aqara-plug-outlet", importUrl: "https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-xiaomi-aqara-plug-outlet-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Xiaomi/Aqara Plug/Outlet (w/ healthStatus)', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-xiaomi-aqara-plug-outlet', 'importUrl': 'https://raw.githubusercontent.com/kkossev/hubitat-Markus-Li-fork/release/drivers/expanded/zigbee-xiaomi-aqara-plug-outlet-expanded.groovy']
